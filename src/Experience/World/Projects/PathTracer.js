...
export default class PathTracer {
    constructor() {
        ...
        //model file location
        this.projectModel = this.resources.items.pathTracer
    ...
    */
    ...
    setAnimation() {
        ...
        this.animation.mixer05 = new THREE.AnimationMixer()
        this.animation.action01 = this.animation.mixer01.clipAction(this.projectModel.animations[0], this.model.children[1])
        this.animation.action02 = this.animation.mixer02.clipAction(this.projectModel.animations[1], this.model.children[2])
        this.animation.action03 = this.animation.mixer03.clipAction(this.projectModel.animations[2], this.model.children[3])
        this.animation.action04 = this.animation.mixer04.clipAction(this.projectModel.animations[3], this.model.children[5])
        this.animation.action05 = this.animation.mixer04.clipAction(this.projectModel.animations[4], this.model.children[6])
        this.animation.action01.play()
        this.animation.action02.play()
        this.animation.action03.play()
        this.animation.action04.play()
        this.animation.action05.play()
    }
    update() {
